...
Use the global git-worktree skill for placement, reuse and required cleanup after merge/completion. Verify /.worktrees/ is ignored before creation. Run from the primary checkout; never use sibling or global paths.
...
bash ~/.agents/skills/git-worktree/scripts/worktree-manager.sh create feature/new-feature origin/main --slug project-feature

# Add worktree and create new branch
bash ~/.agents/skills/git-worktree/scripts/worktree-manager.sh create bugfix/urgent origin/main --slug project-hotfix
...
bash ~/.agents/skills/git-worktree/scripts/worktree-manager.sh create hotfix/critical-bug origin/main --slug myapp-hotfix
